    ...
    sections: [
      {
        ...
        badge: 'Overview',
        summary:
          'Powerion helps users monitor energy usage and environmental impact with dashboards designed for clarity, sustainability messaging, and operational action.',
        fields: [
          { label: 'Product', value: 'Powerion — energy management platform (marketing + product UI)' },
          { label: 'Site', value: 'https://powerion.eu/' },
          { label: 'Problem', value: 'Energy and impact data was hard to scan — operators needed one place to see signals and act' },
          { label: 'Process', value: 'Mapped monitoring journeys, clarified hierarchy for live metrics, and aligned marketing claims with product screens' },
          { label: 'Decision', value: 'Led with status and alerts, then drill-downs — kept sustainability messaging concrete, not decorative' },
          { label: 'Result', value: 'Operators can spot usage and impact signals faster and move to action from a single view' },
        ],
        body: [
          'This case study focuses on how dashboard structure and visual hierarchy turn dense energy data into decisions — without inventing performance metrics.',
          DISCLAIMER,
        ],
      },
      {
      ...
      },
      {
        ...
        badge: 'Challenge',
        summary:
          'Energy platforms often bury the signal under charts and jargon — users needed credible sustainability messaging and operational clarity in the same product surface.',
        fields: [
          { label: 'Scan', value: 'Live metrics competed for attention without a clear “what needs action” layer' },
          { label: 'Trust', value: 'Sustainability claims had to feel technical and credible, not marketing-only' },
          { label: 'Flow', value: 'Marketing, onboarding, and logged-in monitoring needed one visual language' },
        ],
        body: [
          'Every screen had to answer: what is happening with energy usage right now, how does it affect impact goals, and what should I do next?',
        ],
      },
      {
        id: 'role',

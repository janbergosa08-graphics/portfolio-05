  ...
  sections: [
    {
      ...
      badge: 'Overview',
      summary:
        'This portfolio is a professional presentation of UI/UX design work, process, and capabilities. The site exists to help recruiters, hiring teams, and collaborators understand the work and decide whether to start a conversation.',
      fields: [
    ...
    },
    {
      ...
      icon: 'Shield',
      badge: 'Data',
      summary: 'Privacy is intentionally simple: the site does not operate an analytics or advertising stack, does not sell personal information, and only handles information that a visitor deliberately sends through the contact form or email.',
      fields: [
    ...
    },
    {
      ...
      icon: 'Scale',
      badge: 'Terms',
      summary: 'These terms explain what visitors may do with the portfolio, which uses require permission, and the practical limits that protect the site, its content, and the people whose work may appear in project context.',
      fields: [

    ...
    sections: [
      {
        ...
        fields: [
          ...
          { label: 'Focus', value: 'Flow mapping, simulation controls, operational clarity' },
          { label: 'Deliverable', value: 'End-to-end UI/UX, brand visuals, dev-ready handoff' },
        ],
        body: [
          'The goal was an intuitive interface where users map, analyze, and understand complex processes through visual diagrams — improving clarity and decision-making without overwhelming first-time users.',
          DISCLAIMER,
        ],
      },
      {
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { label: 'Focus', value: 'Trust, feature communication, registration & trade flows' },
          { label: 'Deliverable', value: 'Responsive web UI, components, dev-ready handoff' },
        ],
        body: [
          'The public site communicates key benefits, showcases features, and guides users through registration, item listing, and trade flows while reinforcing security and reliability.',
          DISCLAIMER,
        ],
      },
      {
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { label: 'Focus', value: 'API workflows, onboarding, dashboard patterns, design system' },
          { label: 'Deliverable', value: 'Hi-fi UI, flows, component library, Behance case presentation' },
        ],
        body: [
          'The goal was legibility: founders and developers evaluating the platform should understand capabilities and next steps in under two minutes — without feeling intimidated by backend complexity.',
          DISCLAIMER,
        ],
      },
      {
